...
const account1 = {
  ...
  movementsDates: [
    ...
    "2021-06-07T23:36:17.929Z",
    "2021-06-14T10:51:36.790Z",
  ],
  currency: "EUR",
  locale: "pt-PT", // de-DE
};
...
//Doesn't work if it doesn't start with a number
console.log(Number.parseInt("e23px", 10));
...
console.log(645646546541352132846854546541651465146541n);
const now = new Date();
console.log(now);
...
const days1 = calculateDaysPassed(
